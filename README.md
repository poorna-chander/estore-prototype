# E-Store Prototype: That sells Books and other Learning Content

An online E-store system built in Java 8=>11 and springboot 2.6.2

Project was built to demostrate my learnings in:
...
![](docs/UIScreenshotsPart2/login.png)

#### Home page:

![](docs/UIScreenshotsPart2/home.png)

![](docs/UIScreenshotsPart2/home2.png)

#### Cart Page:

![](docs/UIScreenshotsPart2/cart.png)

#### Admin Main Page - delete add update items:

![](docs/UIScreenshotsPart2/admin_add_items.png)

#### Admin Page - add new product:

![](docs/UIScreenshotsPart2/admin_add_product.png)

#### Admin Page - update product:

![](docs/UIScreenshotsPart2/admin_update_product.png)

#### Author Product Request:

![](docs/UIScreenshotsPart2/author_request.png)

#### Search:

![](docs/UIScreenshotsPart2/product_search.png)

#### Purchase History:

![](docs/UIScreenshotsPart2/purchase_history.png)

#### Inventory History:

![](docs/UIScreenshotsPart2/admin_inventory_history.png)
...
![](docs/SequenceDiagrams/User_Add_items_to_cart.jpg)

- ###### 2) Admin adding new product in inventory:

![](docs/SequenceDiagrams/Admin_Create_Product.jpg)

- ###### 3) User Authentication:

![](docs/SequenceDiagrams/authentacate_user.png)

- ###### 4) Admin Update Product:

![](docs/SequenceDiagrams/update_product.png)

- ###### 5) User Search Product:

![](docs/SequenceDiagrams/search_product.jpg)
...
- The system is divided into three Packages (as shown below):
  ![](docs/ClassDiagrams/packageDiagram.png)

#### Static view of classes and relatons within packages:

![](docs/ClassDiagrams/classsrelation.png)

#### Detailed class diagram of Model Package:

![](docs/ClassDiagrams/modelclassdiag.png)

#### Detailed class diagram of persestince Package:

![](docs/ClassDiagrams/persistenceclassdiag.png)

#### Detailed class diagram of controller Package:

![](docs/ClassDiagrams/controllerclassdiag.png)
...
![](docs/StaticCodeAnalysis/BackendAPImetricsImprovements.png)

###### Frontend UI

![](docs/StaticCodeAnalysis/FrontendUImetricsImprovements.png)
...
![](docs/CodeCoverageScreenShots/controller_tier_high_level.png)

![](docs/CodeCoverageScreenShots/controller_low_level.png)

#### Model Tier - coverage

The following is the coverage at the Model Tier code for the project.

![](docs/CodeCoverageScreenShots/model_tier_high_level.png)

#### Persistence Tier - coverage

The following is the coverage at the Persistence Tier code for the project.

![](docs/CodeCoverageScreenShots/persistance_high_level.png)
...
![](docs/CodeCoverageScreenShots/coveragechangesprint3.png)
